    ...
    operations = [
            ...
            fields=[
                ...
                ('image',
                    models.ForeignKey(blank=True,
                                      to='working_waterfronts_api.Image',
                                      null=True)),
            ],
            options={
            },
            ...
            fields=[
                ('id',
                    models.AutoField(verbose_name='ID', serialize=False,
                                     auto_created=True, primary_key=True)),
                ('preparation',
                    models.ForeignKey(to='working_waterfronts_api.Preparation')),
                ('product',
                    models.ForeignKey(to='working_waterfronts_api.Product')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', models.DateTimeField(auto_now=True)),
                ('images',
                    models.ManyToManyField(to='working_waterfronts_api.Image',
        ...
        migrations.AddField(
            model_name='story',
            name='videos',
            field=models.ManyToManyField(to='working_waterfronts_api.Video',
                                         null=True, blank=True),
            preserve_default=True,
        ),
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                through='working_waterfronts_api.ProductPreparation',
                to='working_waterfronts_api.Preparation'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='product',
